...
import sty from "./PlasmicButton.module.css"; // plasmic-import: j9EbzKQ8QuL/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 3LfTzoxL1Tv/icon
import Icon4Icon from "./icons/PlasmicIcon__Icon4"; // plasmic-import: 2JTyDdbmhtT/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__uPyr)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon4Icon
                className={classNames(projectcss.all, sty.svg__uh5Mm)}
                role={"img"}
              />
            ),
